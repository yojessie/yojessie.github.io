...
시작하기 버튼을 동작하게 하기 위해서는, 여러 단계가 필요하다.

1. 시작일을 선택했고 & 예산금액 input이 비어있지 않으며 & 1000 이상의 값을 입력했다면 버튼 활성화<br>
   일단 원하는 기능은 구현했으나,<br>
   다양한 예외상황에 대응하기 위해 조건문을 추가하다보니 코드가 꽤 지저분해진 것 같다.<br>
   ![img05](https://user-images.githubusercontent.com/81657811/201322374-bfa2ab7a-8273-4046-bf73-e9c1e68883d4.gif)
2. 시작일과 예산금액의 값을 로컬에 저장하기
3. 저장된 값을 spend 페이지에 반영시키기
4. intro에서 spend 페이지로 화면 전환시키기

<br><br>

#### [TO-DO LIST]

- 시작일 옵션 범위를 현재 월에 맞게 불러오기
- 저장한 시작일 기준 한달간의 범위 잡아 표시하기
